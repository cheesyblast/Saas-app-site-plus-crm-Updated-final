  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-zinc-950 flex items-center justify-center">
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.pexels.com/photos/5843171/pexels-photo-5843171.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)",
        }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-zinc-950/80 via-zinc-950/90 to-zinc-950" />

      <div className="relative z-10 w-full max-w-md px-6 py-10 border border-zinc-800 bg-zinc-950/80 backdrop-blur-xl">
        <div className="mb-10">
          <div className="text-[#FF3B30] text-xs font-heading uppercase tracking-[0.5em] mb-3">
            Threadline.
          </div>
          <h1 className="font-heading text-4xl font-black uppercase tracking-tighter mb-2">
            Sign in
          </h1>
