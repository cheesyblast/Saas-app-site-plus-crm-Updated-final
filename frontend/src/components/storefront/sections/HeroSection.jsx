...
export default function HeroSection({ config }) {
  ...
  // Sizes per line (with backwards compat: headline_size applies to both if line-specific not set)
  ...
  // Video controls: autoplay muted; user can unmute and pause
      ...
      <div className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 ${heightClass} flex flex-col justify-center`}>
        <div className="max-w-3xl animate-fade-up">
          ...
          {(c.headline_line1 || c.headline_line2) && (
            <h1 className="font-heading font-black uppercase tracking-tighter leading-[0.9] mb-6" style={{ fontFamily: "var(--font-heading)" }}>
          ...
          {c.subheading && (
            <p className="text-zinc-300 max-w-xl text-base sm:text-lg leading-relaxed mb-10" style={{ fontFamily: "var(--font-body)" }}>
              {c.subheading}
            </p>
          )}
